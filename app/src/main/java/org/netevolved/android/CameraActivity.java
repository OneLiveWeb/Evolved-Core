...
public class CameraActivity extends AppCompatActivity implements AndroidBean {

    protected EvolvedCore fieldEvolvedCore;

    public EvolvedCore getEvolvedCore() {
        if (fieldEvolvedCore == null) {
            fieldEvolvedCore = (EvolvedCore)MainActivity.getEngine().getModuleManager().getBean("evolvedCore");
    ...
    private void startCamera() {
        ...
        PreviewConfig pConfig = new PreviewConfig.Builder().setTargetAspectRatio(AspectRatio.RATIO_4_3).build();
        ...
        findViewById(R.id.capture_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PageManager pm = getEvolvedCore().getPageManager();
                Page target=  pm.getPage("/evolved/photos/");
                File parentfolder = new File( target.getContentItem().getAbsolutePath());
                parentfolder.mkdirs();
                long time = System.currentTimeMillis();
                File file = new File(parentfolder, time + ".jpg");

                imgCap.takePicture(file, getMainExecutor(), new ImageCapture.OnImageSavedListener() {
                    @Override
                    ...
                    public void onError(@NonNull ImageCapture.ImageCaptureError imageCaptureError, @NonNull String message, @Nullable Throwable cause) {
                        String msg = "Photo capture failed: " + file.getAbsolutePath();
                        Toast.makeText(getBaseContext(), msg, Toast.LENGTH_LONG).show();
                    }
                });
            }
        ...
        analysis.setAnalyzer(getMainExecutor(),
