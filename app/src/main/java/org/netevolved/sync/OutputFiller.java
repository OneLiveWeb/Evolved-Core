...
public class OutputFiller
{
	...
	public void fill(Reader in, Writer out) throws IOException
	{
...
//	}
	...
	public void fill(InputStream in, OutputStream out, boolean autoclose) throws IOException
	{
		fill(in,out);
		if( autoclose)
		{
	...
	public void fill(InputStream in, OutputStream out) throws IOException
	{
